...
Tags: responsive, menu, responsive menu, responsive menu pro, mobile menu, wordpress responsive menu, wp responsive menu, tablet menu, mobile, tablet, 3 lines, 3 line, three line, three lines
...
This is the Pro version of the Responsive Menu Plugin for WordPress

== Description ==

This is the pro version of the Responsive Menu Plugin for WordPress, with over 73 customisable options for a nice mobile menu or tablet menu experience enabling you to change the: 
<br />
<ul>
<li> - Menu Title</li>
...
<li> - Ability to reset options back to default</li>
<li> - Set colour themes to choose from</li>
<li> - Header bar creator</li>
<li> - Single menu site option</li>
<li> - Only show on mobile option</li>
<li> - Option to set menu to auto-height</li>
<li> - Option to set links to wrap around</li>
<li> - Plus more...</li>
</ul>
...
<br /><br />
It requires no shortcodes (although you can use them) or fancy php code to be inserted by yourself making it very easy to install, and with a huge range of customisable options, you can get it to look exactly as you want it to or leave it with its default values to have it looking amazing in just a matter of seconds.
<br /><br />
...
1. Upload `responsive-menu-pro` to the `/wp-content/plugins/` directory
2. Activate the plugin through the `Plugins` menu in WordPress
3. Set your options from the Responsive Menu Pro admin area
...
* Updated header functionality when used with single menu
* Added Custom CSS option
* Added option to include search box in header
* Added option to include header bar logo link

= 1.0.7 (11th Sept 2015) =
* Fixed issue with menu top padding with header bar
* Added empty check to additional html content
* Fixed menu not opening on first click bug
* Added option to set the search box text
* Fixed wp_is_mobile bug

= 1.0.6 (19th Aug 2015) =
* Fixed middle mouse scroll button bug

= 1.0.5 (13th Aug 2015)
* Fixed bug with longer menus and no background scroll option

= 1.0.4 (13th Aug 2015)
* Fixed bug with pushing button with animation from right side
* Fixed bug with accordion sub arrows not resetting correctly

= 1.0.3 (5th Aug 2015)
* Fixed bug with sub-arrows not being added correctly

= 1.0.2 (28th July 2015)
* Fixed issue with header bar

= 1.0.1 [PRO] (27th July 2015) =
* Import/Export issue with geometric shapes fixed
* Default export.xml file added
* Word Wrap option added
* JS issues fixed
* Other bugfixes

= 1.0 [Pro] (26th July 2015) =
* Initial Pro version released
